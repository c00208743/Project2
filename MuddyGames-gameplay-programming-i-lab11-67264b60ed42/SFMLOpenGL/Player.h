...
const int VERTICE = 24;	// Total Number of Vertices
const int INDICE = 12;	// Total Number of Indexes
const int UV = 48;	// Total Number of UVs
const int COLOR = 24;	// Total Number of Colors
